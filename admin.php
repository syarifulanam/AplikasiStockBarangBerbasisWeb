                                        ...
                                        <form method="post">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" name="emailadmin" class="form-control" placeholder="masukan email" required>
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="modal-content">
                                                    <form method="post">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <label class="form-label">Email Admin</label>
                                                                <input type="email" name="emailadmin" value="<?= $em; ?>" class="form-control" placeholder="masukan email baru" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label class="form-label">Password</label>
